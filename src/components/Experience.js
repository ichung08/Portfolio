...
const Experience = () => {
  return (
    <div>
      <h2>Experience</h2>
      <Post
        pos="Incoming Build Engineer Co-op @ Visier"
      ...
      />
      <Post
        pos="Work Learn IT Support/Web Assistant @ UBC"
      ...
      />
      <Post
        pos="nwHacks Logistics Coordinator @ nwPlus"
        date="06/2021 - Present"
      ...
      />
      <Post
        pos="Undergraduate Computer Science Teaching Assistant @ UBC"
